...
version = None
for line in codecs.open(os.path.join(root_path, 'moneta', '__init__.py'), 'r', encoding='utf-8'):
...
latex_documents = [
    ('index', 'moneta.tex', 'Moneta\'s Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('index', 'moneta', 'Moneta\'s documentation',
     [author], 1)
]
