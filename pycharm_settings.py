...
DATABASES = {'default': {'TEST': {'CHARSET': None, 'COLLATION': None, 'NAME': None, 'MIRROR': None}, 'ENGINE': 'django.db.backends.sqlite3', 'OPTIONS': {}, 'HOST': '', 'NAME': 'django_data/data/database.sqlite3', 'USER': '', 'ATOMIC_REQUESTS': False, 'PORT': '', 'TIME_ZONE': 'UTC', 'PASSWORD': '', 'CONN_MAX_AGE': 0, 'AUTOCOMMIT': True}}
...
REDIS_PORT = '6379'
REPOSITORY_CLASSES = ['moneta.repositories.aptitude.Aptitude', 'moneta.repositories.pypi.Pypi', 'moneta.repositories.maven3.Maven3']
...
STATIC_URL = '/static/'
STORAGES = {'archive': {'ROOT': 'django_data/storage/archives', 'ENGINE': 'moneta.repository.storages.FlatStorage', 'PATH_LEN': 1}, 'cache': {'ROOT': 'django_data/storage/cache', 'ENGINE': 'moneta.repository.storages.FlatStorage', 'PATH_LEN': 1}, 'default': {'ROOT': 'django_data/storage/uncompressed', 'ENGINE': 'moneta.repository.storages.FlatStorage', 'PATH_LEN': 1}}
